...
and saves it to a local file named titanic.xlsx in a folder named data.
"""
...
def main():
    ...
    """
    excel_url = 'https://github.com/DMill31/datafun-03-analytics/blob/main/online-files/Titanic.xlsx'
