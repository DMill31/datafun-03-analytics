"""
This example file fetches a text file of the Back to the Future trilogy from the web 
and saves it to a local file named BTTF.txt in a folder named data.
"""
